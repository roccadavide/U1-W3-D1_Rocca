...
const es1 = (str1, str2) => (str1.slice(0, 2) + str2.slice(-3)).toUpperCase();

console.log(es1("daje", "roma"));
...
const es2 = () => {
  ...
  for (let i = 0; i < 10; i++) {
    tenRandomNum.push(Math.floor(Math.random() * 101));
  }
  return tenRandomNum;
};
